...
namespace Guardian.Data.Migrations
{
    ...
    [Migration("20230127004633_AddForeignKeyToGuardianTable3")]
    partial class AddForeignKeyToGuardianTable3
    {
            ...
            modelBuilder.Entity("Guardian.Domain.Models.GuardianTaskModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = 1,
                            CreatedDate = new DateTime(2023, 1, 26, 21, 46, 33, 307, DateTimeKind.Local).AddTicks(5215),
